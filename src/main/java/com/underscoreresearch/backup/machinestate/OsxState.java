...
/**
 * macOS-specific implementation of MachineState.
 * Provides macOS-specific functionality for battery status detection,
 * application installation, and file change monitoring.
 */
@Slf4j
public class OsxState extends MachineState {
    /**
     * Creates a new OsxState with the specified battery pause setting.
     *
    ...
    /**
     * Checks if the system is running on battery power by querying the power management system.
     *
    ...
    /**
     * Selects the appropriate macOS distribution package (DMG).
     *
    ...
    /**
     * Checks if automatic upgrades are supported on macOS.
     *
     * @return True, as automatic upgrades are supported on macOS
     */
    @Override
    ...
    /**
     * Performs an automatic upgrade by downloading the DMG file and creating a script
     * to mount it and install the application.
     *
    ...
    /**
     * Creates a macOS-specific file change poller.
     *
     * @return An OsxChangePoller instance
