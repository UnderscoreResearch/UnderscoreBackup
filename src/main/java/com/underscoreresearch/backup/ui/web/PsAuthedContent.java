...
/**
 * Authentication pass for encrypted content.
 * This class handles authentication and encryption/decryption of request and response content
 * for the web API.
 */
@Slf4j
public class PsAuthedContent implements Pass {
    ...
    /**
     * Encrypts a response for the client.
     *
    ...
    /**
     * Decodes an encrypted request body.
     *
     * @param request The HTTP request
    ...
    /**
     * Gets the endpoint information for a request or throws an unauthorized exception.
     *
     * @param request The HTTP request
     * @return The endpoint information
     * @throws IOException If the endpoint is not authenticated
     */
    ...
    /**
     * Checks if a method is allowed without password authentication.
     *
     * @param encryptionKey The encryption identity
     * @param path The request path
     * @param method The HTTP method
     * @return True if the method is allowed without password authentication
     */
     ...
     * Validates the key exchange header and returns an identity if authentication is successful.
     *
     * @param request The HTTP request
     * @return An optional identity if authentication is successful
     * @throws Exception If there's an error during authentication
     */
    @Override
    ...
    /**
     * Validates a key exchange.
     * Checks the nonce, hash, and public key hash for authentication.
     *
     * @param request The HTTP request
     ...
     * @return True if the key exchange is valid
     * @throws IOException If there's an error during validation
     */
...
//        System.out.printf("%s == %s?%n", hash, expectedHash);
     ...
     * @throws IOException Always throws an unauthorized exception
     */
    ...
    /**
     * Processes a response after authentication.
     *
