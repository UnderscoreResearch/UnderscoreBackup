...
import static com.underscoreresearch.backup.ui.web.methods.PingGet.getSiteUrl;
...
/**
 * Web endpoint for retrieving the current state of the backup system.
 * This class handles requests to get information about the system state, configuration, and available updates.
 */
@Slf4j
public class StateGet extends BaseWrap {
    ...
    /**
     * Creates a new StateGet instance.
     */
    public StateGet() {
    ...
    /**
     * Class representing information about a new version of the software.
     */
    @Data
    private static class NewVersion {
        ...
        /**
         * Creates a new NewVersion instance from a release response.
         *
        ...
        /**
         * Creates a NewVersion instance from a release response, or returns null if the release is null.
         *
         * @param release The release response
         * @return A NewVersion instance or null
         */
    ...
    /**
     * Response class for state requests.
     * Contains information about the system state, configuration, and available updates.
     */
    @Data
    @NoArgsConstructor
    @AllArgsConstructor
    ...
    /**
     * Implementation class that handles state requests.
     */
    private static class Implementation extends BaseImplementation {

        /**
         * Processes a request to get the system state.
         * Returns information about the system state, configuration, and available updates.
         *
         * @param req The HTTP request
         * @return The HTTP response containing the system state
            ...
            try {
                ...
                if (InstanceFactory.hasConfiguration(false)) {
                    ...
                    if (sourceConfig != null) {
                        validDestinations = ConfigurationPost.cachedValidDestinations(sourceConfig);
                    }
                }
