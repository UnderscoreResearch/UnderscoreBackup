...
/**
 * Command for displaying information about the contents of the backup repository.
 * This command provides statistics about files, versions, blocks, and storage usage.
 */
...
public class RepositoryInfoCommand extends SimpleCommand {
    /**
     * Executes the repository-info command to display statistics about the repository.
     *
     * @throws Exception If an error occurs while gathering repository information
     */
