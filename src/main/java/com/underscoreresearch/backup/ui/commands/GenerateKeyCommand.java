...
/**
 * Command for generating a new encryption key pair.
 * This command creates a new public/private key pair for encrypting backup data,
 * or adds an additional key for sharing purposes.
 */
...
public class GenerateKeyCommand extends Command {
    /**
     * Generates a new encryption key pair and saves it to disk.
     *
     * @param commandLine The parsed command line arguments
     * @param firstTry The password for the private key
     * @return The path to the saved key file
     * @throws IOException If an error occurs saving the key
     * @throws GeneralSecurityException If an error occurs generating the key
     */
    ...
    /**
     * Gets the default file name for the encryption key.
     *
     * @param commandLine The parsed command line arguments
     * @return The default encryption key file
     */
    ...
    /**
     * Executes the generate-key command with the specified command line arguments.
     *
     * @param commandLine The parsed command line arguments
