...
/**
 * Command for restoring files from backup.
 * This command allows restoring files to their original location or to a different destination,
 * with options for recursive restoration, overwriting existing files, and handling permissions.
 */
...
public class RestoreCommand extends Command {
    ...
    /**
     * Executes the restore command with the specified command line arguments.
     *
     * @param commandLine The parsed command line arguments
     * @throws Exception If an error occurs during the restore operation
     */
    @Override
