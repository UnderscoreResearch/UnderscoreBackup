...
import com.underscoreresearch.backup.ui.commands.Command;
import com.underscoreresearch.backup.ui.commands.CommandPlugin;
...
/**
 * Main entry point for the Underscore Backup command-line interface.
 * This class handles command-line parsing, initialization, and execution of commands.
 */
@Slf4j
public final class Main {
    ...
    /**
     * Main method that initializes the application, parses command-line arguments,
    ...
    /**
     * Validates the configuration for a command.
     *
     * @param commandDef The command definition
     * @param configFetcher A supplier for the configuration
