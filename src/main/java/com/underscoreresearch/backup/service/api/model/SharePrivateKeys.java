...
public class SharePrivateKeys {
    ...
    public String toString() {
        String sb = "class SharePrivateKeys {\n" +
                "    publicKey: " + toIndentedString(publicKey) + "\n" +
                "    encryptedKey: " + toIndentedString(encryptedKey) + "\n" +
                "}";
        return sb;
    }
    ...
    public String toUrlQueryString(String prefix) {
        ...
        if (getPublicKey() != null) {
            joiner.add(String.format("%spublicKey%s=%s", prefix, suffix, URLEncoder.encode(getPublicKey(), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
        }

        // add `encryptedKey` to the URL query string
        if (getEncryptedKey() != null) {
            joiner.add(String.format("%sencryptedKey%s=%s", prefix, suffix, URLEncoder.encode(getEncryptedKey(), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
        }
