...
public class GenerateTokenRequest {
    ...
    public String toString() {
        String sb = "class GenerateTokenRequest {\n" +
    ...
    public String toUrlQueryString(String prefix) {
        ...
        if (getClientId() != null) {
            joiner.add(String.format("%sclientId%s=%s", prefix, suffix, URLEncoder.encode(getClientId(), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
        }

        // add `code` to the URL query string
        if (getCode() != null) {
            joiner.add(String.format("%scode%s=%s", prefix, suffix, URLEncoder.encode(getCode(), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
        }

        // add `codeVerifier` to the URL query string
        if (getCodeVerifier() != null) {
            joiner.add(String.format("%scodeVerifier%s=%s", prefix, suffix, URLEncoder.encode(getCodeVerifier(), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
        }
